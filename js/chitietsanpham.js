...
window.onload = function () {
    ...
    var tags = ["Louis Vuitton", "Gucci", "Dior", "hermes", "Chanel"];
...
function phanTich_URL_chiTietSanPham() {
    ...
    console.log('nameProduct can tim **************************************');
    ...
    */
    ...
    console.log('khong co link san pham');
    ...
    //hinh.src = "img/products/balenxámbọcdây.jpg";
    //document.getElementById('bigimg').src = "balenxámbọcdây.jpg";
