...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo.jpg" alt="Trang chủ Ray House" title="Trang chủ Ray House">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Ray House</a> - All rights reserved © 2022 - Designed by Gô</p>
    </div>`);
}
    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                ...
                <li>đường chỉ khéo tay</li>
                <li>Hỗ trợ suốt thời gian sử dụng.
                    <br>Fanpage:
                    <a href="https://www.facebook.com/RAY-HOUSE-107308301745296" style="color: #288ad6;">Ray House</a>
                </li>
            </ul>
        </section>
    </div>`);
